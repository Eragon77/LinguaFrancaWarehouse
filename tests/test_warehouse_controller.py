...
class TestWarehouseControllerFundamentals:
    ...
    def test_extract_with_tray_number_requires_empty_bay(
        self, controller, mock_warehouse
    ):
    ...
    def test_extract_from_queue_requires_occupied_queue(
        self, controller, mock_warehouse
    ):
    ...
    def test_tick_processes_lock_action(
        self, mock_get_action, controller, mock_warehouse
    ):
    ...
    @patch("warehouse_controller.get_next_action_from_egglog")
    def test_tick_transitions_to_deliver_after_pick(
        self, mock_get_action, controller, mock_warehouse
    ):
    ...
    @patch("warehouse_controller.get_next_action_from_egglog")
    def test_tick_completes_mission_after_place(
        self, mock_get_action, controller, mock_warehouse
    ):
    ...
    @patch("warehouse_controller.get_next_action_from_egglog")
    def test_tick_resets_on_action_failure(
        self, mock_get_action, controller, mock_warehouse
    ):
