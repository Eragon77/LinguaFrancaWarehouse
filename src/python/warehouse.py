...
class Warehouse:
    ...
    def __init__(self):
        ...
        for i in range(self.NUM_ROWS):
            ...
            left_slot = Slot(
                slot_id=left_id, x=self.X_LEFT, y=y_pos, slot_type="storage"
            )
            ...
            if i < 3:  # Rows 0-2 (Queue)
                ...
                new_slot = Slot(
                    slot_id=slot_id, x=self.X_RIGHT, y=y_pos, slot_type="queue"
                )
                ...
                # Added slot_type="bay"
                new_slot = Slot(
                    slot_id=slot_id, x=self.X_RIGHT, y=y_pos, slot_type="bay"
                )
                ...
                # Added slot_type="storage"
                new_slot = Slot(
                    slot_id=slot_id, x=self.X_RIGHT, y=y_pos, slot_type="storage"
                )
